...
const handlers = [CreateBlogHandler, DeleteBlogHandler, UpdateBlogHandler, CreatePostHandler, DeletePostHandler, UpdatePostHandler];
const adapters = [BlogsRepositories, BlogsQueryRepositories, PostsRepositories, PostsQueryRepositories, UsersQueryRepositories, JwtService];
